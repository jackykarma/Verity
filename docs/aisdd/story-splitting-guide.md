...
> **定位**：EPIC 软件设计说明书 §十二的拆解方法论与约束详解。模板 `epic-design-doc-template.md` 仅保留摘要与自检清单；撰写或评审 Story 时以本文为准。
...
- **工作量**：工作量是粒度的**参考信号，不是拆分的强约束**；拆分决策首先看改动路径独立性与技术边界合理性
  - 典型区间 **2～5 人天**（含编码、联调、CR、自检）
...
| 版本 | 日期 | 变更摘要 |
|------|------|----------|
| v1.0.0 | 2026-05-22 | 从 `epic-design-doc-template.md` §12.1～§12.2 抽出，供模板与 `/aisdd.epicdesign story` 引用 |
