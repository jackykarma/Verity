---
name: jacky-bbc-6-minute-crawler
...
```bash
python .cursor/skills/jacky-bbc-6-minute-crawler/scripts/crawler.py --config <配置名> --output <输出目录> [--days <天数>]
```
...
python .cursor/skills/jacky-bbc-6-minute-crawler/scripts/crawler.py --config bbc-6-minute --output docs/bbc-6-minutes --days 30
```
...
- 配置文件目录: `.cursor/skills/jacky-bbc-6-minute-crawler/configs/`
- 爬虫脚本: `.cursor/skills/jacky-bbc-6-minute-crawler/scripts/crawler.py`
