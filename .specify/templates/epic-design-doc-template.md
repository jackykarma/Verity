...
├──────────────────────────────────────────────────────────────────────────────────┤
│  Gate 2  │ §六 + key-func   │ 关键设计策略  │ 疑难点/亮点 + Feature 流程图集      │
│          │   -design.md     │              │ （产出 key-func-design.md 完整内容） │
├──────────────────────────────────────────────────────────────────────────────────┤
│  Gate 3  │ §七 + key        │ 全景类图与时序│ 骨架类图 + Feature 子类图 + 时序图   │
│          │   -diagram.md    │              │ （产出 key-diagram.md 完整内容）     │
├──────────────────────────────────────────────────────────────────────────────────┤
...
│          │ + story_detail   │              │ （产出各 Feature 的                 │
│          │   _design.md     │              │   story_detail_design.md）         │
└──────────────────────────────────────────────────────────────────────────────────┘
```
...
> **范围**：§六（关键设计疑难点/亮点）+ `key-func-design.md`（完整内容，含方案流程图 + Feature 流程图集）。
>
> **确认人**：Tech Lead / 架构师 / 开发负责人
>
...
> **范围**：§七（图表概览摘要）+ `key-diagram.md`（完整内容，含全景骨架类图、Feature 子类图（含方法签名）、关键时序图）。
>
> **确认人**：Tech Lead / 架构师 / 开发负责人
>
