...
### 🟤 Git 提交和推送
**使用:** [git-commit-push/SKILL.md](git-commit-push/SKILL.md)
...
### 📊 竞品分析
**使用:** [competitor-analysis/SKILL.md](competitor-analysis/SKILL.md)
...
**核心功能:**
- 产品功能维度分析（用户体验、功能对比、差异化）
- 技术实现维度分析（架构设计、技术选型、性能）
- 生成结构化分析报告
- 提供可落地的借鉴建议
- 输出差异化策略和实施路线图
...
### Git 提交规范
**Skill:** [git-commit-push](git-commit-push/SKILL.md)  
**章节:** Commitizen 中文规范
...
### 竞品分析
**Skill:** [competitor-analysis](competitor-analysis/SKILL.md)  
**章节:** 分析流程
...
| 提交代码 | git-commit-push | 完整工作流程 |
| 推送 GitHub | git-commit-push | Git 操作步骤 |
| 竞品分析 | competitor-analysis | 分析流程 |
| 技术选型 | competitor-analysis | 技术实现分析 |
| 产品调研 | competitor-analysis | 产品功能分析 |
